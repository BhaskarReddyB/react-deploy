    ...
    return(
        <div>
            ...
            <div className="navbar">
                <a href="#"className="help">Need Help?</a> <span className="call">call us </span> <span className="number">1-22-3456789</span>
        
        <nav className="n">
            <ul>
                <li><a href="">Register</a></li> <i>|</i>
                <li><a href="">Login</a></li> <i>|</i>
                <li><a href="">Delivery</a></li> <i>|</i>
                <li><a href="">Checklist</a></li> <i>|</i>
